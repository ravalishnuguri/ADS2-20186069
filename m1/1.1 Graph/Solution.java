...
class Unidrectedgraphforlist {
     ...
     * @param      scan  The scan
     */
    Unidrectedgraphforlist(final Scanner scan) {
...
class Undirectedgraphforbag {
    ...
    */
     ...
     * @param      scan  The scan
     */
    Undirectedgraphforbag(final Scanner scan) {
        this.vertices = Integer.parseInt(scan.nextLine());
...
final class Solution {
    ...
    public static void main(final String[] args) {
        ...
        switch (type) {
        case "List":
            Undirectedgraphforbag graphObj = new Undirectedgraphforbag(scan);
            System.out.println(graphObj);
            break;
        case "Matrix":
            Unidrectedgraphforlist graphMat = new Unidrectedgraphforlist(scan);
            graphMat.print();
            break;
        default : break;
        }
