...
public class TST<Value> {
    ...
    public String longestPrefixOf(final String query) {
        if (query == null) {
            throw new IllegalArgumentException("calls longestPrefixOf()");
        }
        if (query.length() == 0) {
            return null;
        }
    ...
    public Iterable<String> keysWithPrefix(final String prefix) {
        if (prefix == null) {
            throw new IllegalArgumentException("calls keysWithPrefix");
        }
        Queue<String> queue = new Queue<String>();
    ...
    /**
     * Returns all of the keys in the symbol table that. where . symbol is
     * treated as a wildcard character.
     *
     * @param      pattern  the pattern
     *
     * @return     all of the keys in the symbol as an iterable, where . is
     *             treated as a wildcard character.
     */
